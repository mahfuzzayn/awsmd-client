    ...
    return (
        <div className="navigation">
            ...
            <div className="flex gap-4 items-center fixed top-7 lg:top-9 right-10 z-110">
                ...
                {/* Hamburger */}
                <button className={clsx("h-12 w-12 rounded-full bg-white/30 flex justify-center items-center cursor-pointer transition-colors duration-300", { "bg-[#a99f9fdb]!": hasScrolled }, { "bg-white/40!": isMenuOpen })} onClick={() => setIsMenuOpen(!isMenuOpen)}>
